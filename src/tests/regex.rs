...
mod tests {
    ...
    fn test_into_type_basic_chars() {
        let mut chars = "".chars();
        assert!(matches!(
            Regex::into_type('a', &mut chars),
            RegexType::Char('a')
        ));
        assert!(matches!(
            Regex::into_type('1', &mut chars),
            RegexType::Char('1')
        ));
        assert!(matches!(
    ...
    fn test_add_concatenation_with_escaped_chars() {
        ...
        assert!(matches!(
            result[2],
            TokenType::Literal(RegexType::Char('\n'))
        ));
        assert!(matches!(
            result[3],
            TokenType::BinaryOperator(RegexType::Concatenation)
    ...
    fn test_regex_new_with_complex_pattern() -> ParsingResult<()> {
        ...
        assert!(matches!(
            result[5],
            TokenType::UnaryOperator(RegexType::Quant(Quantifier::Range(0, 1)))
        ));
        assert!(matches!(
            result[6],
            TokenType::BinaryOperator(RegexType::Concatenation)
    ...
    fn test_regex_new_with_nested_groups() -> ParsingResult<()> {
        ...
        assert!(matches!(
            result[6],
            TokenType::Literal(RegexType::Char('e'))
        ));
        assert!(matches!(
            result[7],
            TokenType::BinaryOperator(RegexType::Concatenation)
        ...
        assert!(matches!(
            result[9],
            TokenType::Literal(RegexType::Char('f'))
        ));
        assert!(matches!(
            result[10],
            TokenType::BinaryOperator(RegexType::Concatenation)
